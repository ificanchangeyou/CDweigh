...
namespace CDweigh
{
    ...
    public class CHCNetSDK
    {
        ...
        public const int Barrier_Stop = 2;//停止道闸
        public const int Barrier_Lock = 3;//锁定道闸
        //SDK类型
        public const int NET_DVR_VEHICLE_DELINFO_CTRL = 3125;//删除设备内黑名单数据库信息
        public const int NET_DVR_BARRIERGATE_CTRL = 3128;//远程控制道闸
        public const int NET_DVR_GATELAMP_CTRL = 3129;//常量灯功能
		...
		**********************************************************/
        ...
        public struct NET_DVR_BARRIERGATE_CFG
        {
            public uint dwSize;//结构体大小
            public uint dwChannel;//通道号
            public byte byLaneNo;//道闸号 0-无效 1-道闸
            public byte byBarrierGateCtrl; //0-关 1-开 2-停 3锁
            public byte byEntranceNo;
            public byte byUnlock;
            public byte[] byRes; //保留位置0
        }
